...
public record ReleaseGet : IRequest<ReleaseDto>
{
    [FromRoute]
...
public class ReleaseGetHandler : IRequestHandler<ReleaseGet, ReleaseDto>
{
    ...
    public async Task<ReleaseDto> Handle(ReleaseGet request, CancellationToken cancellationToken)
    {
