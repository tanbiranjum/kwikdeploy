...
namespace KwikDeploy.Application.Releases.Commands.ReleaseUpdate;

public record ReleaseUpdateCommand : IRequest
{
    [FromRoute]
    ...
    [FromBody]
    public ReleaseUpdateCommandBody Body { get; init; } = null!;
}

public record ReleaseUpdateCommandBody
{
    public string Name { get; init; } = null!;
}


public class ReleaseUpdateCommandHandler : IRequestHandler<ReleaseUpdateCommand>
{
    private readonly IApplicationDbContext _context;

    public ReleaseUpdateCommandHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task Handle(ReleaseUpdateCommand request, CancellationToken cancellationToken)
    {
        // Existance Check
