...
public record TargetCreate : IRequest<Result<int>>
{
    [FromRoute]
    public int ProjectId { get; init; }

    [FromBody]
    public TargetCreateBody Body { get; init; } = null!;
}

public record TargetCreateBody
{
    public string Name { get; init; } = null!;
}

public class TargetCreateHandler : IRequestHandler<TargetCreate, Result<int>>
{
    ...
    public async Task<Result<int>> Handle(TargetCreate request, CancellationToken cancellationToken)
    {
