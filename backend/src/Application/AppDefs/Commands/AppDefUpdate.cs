...
public record AppDefUpdate : IRequest
{
    [FromRoute]
    ...
    [FromBody]
    public AppDefUpdateBody Body { get; init; } = null!;
}

public record AppDefUpdateBody
{
...
public class AppDefUpdateHandler : IRequestHandler<AppDefUpdate>
{
    private readonly IApplicationDbContext _context;

    public AppDefUpdateHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task Handle(AppDefUpdate request, CancellationToken cancellationToken)
    {
        // Existance Check
