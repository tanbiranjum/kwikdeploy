...
namespace KwikDeploy.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20231025133002_Variables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KwikDeploy.Domain.Entities.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("KwikDeploy.Domain.Entities.Variable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("KwikDeploy.Domain.Entities.VariableValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("KwikDeploy.Domain.Entities.VariableValue", b =>
                {
                    b.HasOne("KwikDeploy.Domain.Entities.Env", "Env")
                        .WithMany()
                        .HasForeignKey("EnvId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KwikDeploy.Domain.Entities.Variable", "Variable")
                        .WithMany()
